...
$que = "SELECT COUNT(mb_id) AS total FROM g5_member WHERE mb_level = '2' AND mb_hp != '' AND mb_leave_date = '' AND mb_10 = '1' AND mb_5 != 'Y'  ";
echo $que."<br>";
$row = sql_fetch($que);
...
//for($x=0;$x<=$total;$x+=100) {
    ...
    $que = "SELECT * FROM g5_member WHERE mb_level = '2' AND mb_leave_date = '' AND mb_10 = '1' AND mb_10 != '' AND mb_5 != 'Y' ";
    echo $que . "<br>";
