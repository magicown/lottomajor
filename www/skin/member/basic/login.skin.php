...
?>
<div style="min-height: 400px; align-items: center; align-content: center;">
<div style="display: flex; justify-content: center; margin-top:100px;">
	<div class="form-box">
		<div class="form-header">
			<h2><b><i class="fa fa-smile-o"></i>로또메이저 로그인</b></h2>
		</div>
		<div class="form-body">
			...
			<input type="hidden" name="url" value='<?php echo $login_url ?>'>
				...
				<div class="row">
					<div class="col-xs-6">
						<label class="checkbox-inline remember-me" style="font-size:12px;">
