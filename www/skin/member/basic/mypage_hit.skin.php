            ...
            <div class="panel panel-default">
                <ul class="list-group">
                    ...
                    <li class="list-group-item" style="display:flex; justify-content: space-between;">
                        ...
                        <button type="button" class="btn btn-danger" id="change_week" >변경</button>
                    </li>
                </ul>
                <?php if($member['mb_profile']) { ?>
                    <div class="panel-body">
        ...
        $('#change_week').on('click',function(){
            ...
            if(mb_id != '') {
                $.ajax({
                    ...
                    url: jsonurl,
                    dataType: "JSON",
                    data: {"mode": "numWeekChange", "mb_id": mb_id, "mon": $('#mon option:selected').val(), "tue":$('#tue option:selected').val(),"wed":$('#wed option:selected').val(),"thu":$('#thu option:selected').val(),"fri":$('#fri option:selected').val(),"sat":$('#sat option:selected').val()},
