    ...
    <div class="tbl_frm01 tbl_wrap" id="pay_type_card">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="cardNo1" id="cardNo1" class="frm_input" size="10" required>
                    <input type="text" name="cardNo2" id="cardNo2" class="frm_input" size="10" required >
                    <input type="text" name="cardNo3" id="cardNo3" class="frm_input" size="10" required >
                    <input type="text" name="cardNo4" id="cardNo4" class="frm_input" size="10" required >
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="3">
                    <input type="radio" name="pay_type" class="pay_type"  data-pay_type="card" value="card" checked onclick="show_type('card');">신용카드(페이업)
