    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td class="td_extra">
                ...
                <input type="text" name="cf_<?php echo ($i == 8) ? $i.'_old' : $i; ?>" value="<?php echo get_sanitize_input($config['cf_'.$i]); ?>" id="cf_<?php echo $i ?>" class="frm_input extra-value-input" size="30">
            </td>
        </tr>
        <?php } ?>
        </tbody>
