	...
	<div class="row row-15">
        ...
        <div class="col-sm-6  col-md-4" style="padding-left:5px; padding-right:5px;">
            ...
            <!--<div class="w-box" style="padding-bottom:16px;">
                <span class="title-text-sum"><span class="font-red strong">로또메이저</span> 누적 당첨현황</span>
                <div class="line"></div>
	...
	<div class="w-box-black">
        ...
        <div class="col-md-7" id="free_counselor">
            ...
            <div class="span-chk">
                ...
                <span class="agree-yn-text">로또메이저 이용약관(자세히보기)</span>
            </div>
            <div class="span-chk">
                <input type="checkbox" name="private" value="1">
                <span class="agree-yn-text">로또메이저 개인정보처리방침(자세히보기)</span>
            </div>
        </div>
	</div>
	<!--// End -->
        ...
        <div class="col-md-9">
            <div class="rollingContainer">
                <div class="rollingList">
                    <ul>
                        <li><a href="/bbs/500.php"><img src="/img/wing/pa.png" width="261" height="117" alt="로또메이저 A플랜" /></a></li>
                        <li><a href="/bbs/500.php"><img src="/img/wing/pb.png" width="261" height="117" alt="로또메이저 B플랜" /></a></li>
                        <li><a href="/bbs/500.php"><img src="/img/wing/pr.png" width="261" height="117" alt="로또메이저 R플랜" /></a></li>
                        <li><a href="/bbs/500.php"><img src="/img/wing/ps.png" width="261" height="117" alt="로또메이저 S플랜" /></a></li>
    ...
    $('#getFreeNum').on('click',function(){
        ...
        if(hp1 == '' || hp2 == '' || hp3 == ''){
            ...
            if($("input[name='useinfo']").is(':checked') == false){
                alert('로또메이저 이용약관에 동의하셔야 합니다.');
                return false;
            }
            if($("input[name='private']").is(':checked') == false){
                alert('로또메이저개인정보처리방침에 동의하셔야 합니다.');
                return false;
            }
            $.ajax({
                type: "POST",
