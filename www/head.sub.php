...
<link rel="stylesheet" href="<?php echo G5_JS_URL ?>/font-awesome/css/font-awesome.min.css">
    ...
    <!-- THEME CSS -->
    <link href="/css/assets/essentials.css" rel="stylesheet" type="text/css" />
    <link href="/css/assets/layout.css" rel="stylesheet" type="text/css" />

    <!-- PAGE LEVEL SCRIPTS -->
    <link href="/css/assets/header-1.css" rel="stylesheet" type="text/css" />
    <link href="/css/assets/color_scheme/green.css" rel="stylesheet" type="text/css" id="color_scheme" />
    <link href="https://fonts.googleapis.com/css?family=Nanum+Gothic|Noto+Sans+KR&amp;display=swap" rel="stylesheet">

    <link href="/index/css/agency.css" rel="stylesheet" type="text/css" />
